...
export default function NFT(props) {
    ...
    const [durians, setDurians] = useState(0)
    const [durianPrice, setDurianPrice] = useState(0)
    ...
    const handleHiddenValueChange = (event) => {
        setHiddenValue(event.target.value) // Update the hidden value state
    }
    return (
        <Card p="20px">
