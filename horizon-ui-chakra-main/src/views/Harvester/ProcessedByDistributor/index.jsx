...
export default function Marketplace() {
    ...
    const handleDurianSliceChange = (event) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            await contract.methods
                .processedDurianByDistributor(durianId, true, durianSlices)
                    ...
                    <Box p="6">
                        ...
                        <Box my={4} textAlign="left">
                            <SimpleGrid columns={2} spacing={3}>
                                ...
                                <FormControl>
                                    <FormLabel htmlFor="durianSlices" color={textColor}>
                                        Durian Slices
                                    </FormLabel>
                                    <Input
                                        id="durianSlices"
                                        placeholder="Enter Durian slices"
                                        colorScheme="white"
                                        color={textColor}
                                        value={durianSlices}
